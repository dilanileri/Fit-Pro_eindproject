                    ...
                    <div className="relative z-10 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <h1 className="text-3xl font-black text-white">
                                Trainingsschema bewerken
                            </h1>

                            <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-400">
                                Pas het schema aan en beheer welke workouts aan
                                welke trainingsdagen gekoppeld zijn.
                            </p>
                        </div>
                        ...
                        <div className="relative z-10">
                                        ...
                                        return (
                                            ...
                                            >
                                                <label className="flex cursor-pointer items-start gap-4">
                                                    <input
                                                        type="checkbox"
                                                        className="mt-1 h-5 w-5 rounded-md border border-slate-600 bg-slate-900 text-green-500 focus:ring-2 focus:ring-green-400/30" checked={
                                                            !!selectedWorkout
                                                        }
                                                        onChange={(e) =>
                                                            toggleWorkout(
                            ...
                            <div className="mt-8 flex flex-col gap-3 border-t border-slate-800 pt-6 sm:flex-row sm:items-center sm:justify-between">
                                <div className="flex items-center gap-3 text-sm text-slate-500">
                                    ...
                                    Controleer de gekoppelde workouts voordat je
                                    opslaat.
                                </div>
